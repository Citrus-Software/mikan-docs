...
|:----------|:------------|:--------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `create`  | *bool*      | `off`   | If `on`, creates a dedicated transform node named `phonemes` under the current node to host the attributes. If `off`, attributes are added directly to the modifier's target node. |
